                ...
                <div className={'relative pt-[56.25%]'}>
                    ...
                    <div className={'absolute bottom-10 flex w-full items-center justify-between px-10'}>
                        <div className={'flex space-x-2'}>
                            ...
                            <button
                                className={'flex items-center gep-x-2 rounded bg-white px-8 text-xl font-bold text-black transition hover:bg-[#6e6e6e]'}>
                ...
                <div className={'flex space-x-16 rounded-b-md bg-[#181818] px-10 py-8'}>
                    <div className={'space-y-6 text-lg'}>
                        <div className={'flex items-center space-x-2 text-sm'}>
                            ...
                            <div
                                className={'flex h-4 items-center justify-center rounded border border-white/40 px-1.5 text-sm'}>HD
                            </div>
                        </div>
                    </div>
