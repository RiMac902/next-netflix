    ...
    return (
        <div className={'relative flex h-screen w-screen flex-col bg-black md:items-center md:justify-center md:bg-transparent'}>
            ...
            <h1 className={'text-4xl font-semibold'}>Sign in</h1>
                ...
                <button className={'w-full rounded bg-[#E50914] py-3 font-semibold'} onClick={() => setLogin(true)}>Sing In</button>

                <div className={'text-[gray]'}>
                    New to Netflix?{' '}
                    <button type={"submit"} className={'cursor-pointer text-white hover:underline'} onClick={() => setLogin(false)}>Sing up now</button>
                </div>
            </form>
        </div>
    );
